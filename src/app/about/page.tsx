        ...
        <section id="about">
            ...
            <div className={utils.aboutHeading}>
                ...
                <p className={utils.subHeading}>
                    ...
                    sales, technical support and parts service at value for
                    money prices. Our vision is to be the preferred source of
                    world class machinery for the Irish farmer to help them to
                    grow their farm enterprises and continue to make a valuable
                    and increased contribution to the Irish Economy.
                </p>
            </div>
            <Timeline />
            {user && user.role === 'ADMIN' && (
